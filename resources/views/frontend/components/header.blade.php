  ...
  <div class="container">
    <div class="headerTop-inner">
      <ul class="social-links">
        ...
        <li class="social-link"><a href="https://x.com/quriliskr"><i class="fa-brands fa-x-twitter" style="color: #000"></i></a></li>
      </ul>
      <div class="topInner">
        <div class="phone">
        ...
        <div class="top-tools">
          ...
          <div class="specialView" id="spec-btn" style="position: relative">
            ...
            <div class="special-window">
              ...
              <div class="view-change spec-box">
                <button
              ...
              <h4 class="spec-title">Shrift o'lchami</h4>
              <div class="fontSize-change spec-box">
                <button
                  class="btn btn-sm btn-default"
