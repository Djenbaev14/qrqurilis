          ...
          <div class="card-block p-3" style="background: #fff" >
            <form action="{{route('dashboard.pages.update',$page->id)}}" method="POST">
                ...
                <div class="col-md-12">
                  ...
                  <input placeholder="https://qrqurilis.uz/ярлык" type="text" name="slug" id="simpleinput" class="form-control" value="{{$page->slug}}">
                ...
                <div class="tab-content">
                  @foreach (config('app.available_locales') as $local)
                    <div class="tab-pane mt-2  <?=($local['lang']=='ru' ? 'show active' : '')?>" id="page_{{$local['lang']}}">
                      <div class="col-md-12">
                        ...
                        ?>
                        <input type="text" placeholder="{{$local['heading']}}" name="title_{{$local['lang']}}" id="simpleinput" value="{{$page->$title}}" class="form-control">
                      </div>
                      <div class="col-md-12 mt-3">
                          <div class="form-group">
                              <textarea class="form-control" id="editor_{{$local['lang']}}" name="body_{{$local['lang']}}" rows="10" placeholder="Введите текст">{{$page->$body}}</textarea>
                          </div>
                      </div>
                    </div>
                  @endforeach
                ...
                <div class="row">
                    <div class="col-12 mt-3">
                        <button class="btn btn-primary" type="submit" id="save">Өзгертиў</button>
                    </div>
                </div>
            </form>
...
<script>
  ...
  <script type="text/javascript">
    ...
    <script>
        tinymce.init({
            selector: '#body_uz',
            plugins: 'anchor autolink charmap codesample emoticons image link lists media searchreplace table visualblocks wordcount pageembed',
            toolbar: 'undo redo | blocks fontfamily fontsize | bold italic underline strikethrough | link image media table | align lineheight | numlist bullist indent outdent | emoticons charmap | removeformat | pageembed',
